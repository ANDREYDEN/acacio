...
export interface paths {
  ...
  '/ingredients': {
    get: {
      parameters: {
        query: {
          id?: parameters['rowFilter.ingredients.id'];
          supplier?: parameters['rowFilter.ingredients.supplier'];
          last_supply?: parameters['rowFilter.ingredients.last_supply'];
          /** Filtering Columns */
          select?: parameters['select'];
          /** Ordering */
          order?: parameters['order'];
...
export interface definitions {
  ...
  /** @description Holds information about each ingredient */
  ingredients: {
    /**
     * Format: bigint
     * @description Note:
...
export interface parameters {
  ...
  /** Format: bigint */
  'rowFilter.ingredients.id': string;
  /** Format: text */
  'rowFilter.ingredients.supplier': string;
  /** Format: text */
  'rowFilter.ingredients.last_supply': string;
